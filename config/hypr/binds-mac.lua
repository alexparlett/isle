...
hl.bind(cmd .. " + Space",                  hl.dsp.exec_cmd(s.scripts .. "/launcher.sh"), d("Launch bar"))
...
hl.bind(cmd .. " + Return", hl.dsp.exec_cmd(s.term),  d("Terminal"))
hl.bind(cmd .. " + E",      hl.dsp.exec_cmd(s.files), d("File manager"))

hl.bind(cmd .. " + comma", hl.dsp.exec_cmd("python3 ~/.config/hypr/settings/hypr-settings.py"), d("Settings"))
hl.bind(cmd .. " + " .. shift .. " + slash", hl.dsp.exec_cmd(s.scripts .. "/cheatsheet.sh"), d("Keybind cheatsheet"))

hl.bind(cmd .. " + " .. shift .. " + V", hl.dsp.exec_cmd(s.scripts .. "/clipboard.sh"), d("Clipboard history"))
hl.bind(cmd .. " + " .. opt .. " + U",   hl.dsp.exec_cmd(s.term .. " -e cachy-update"), d("System update"))
...
for _, z in ipairs(zones) do
    hl.bind(opt .. " + " .. cmd .. " + " .. z[1], s.snap_to(z[2]), d(z[3]))
end
...
hl.bind(cmd .. " + F10", hl.dsp.exec_cmd("swayosd-client --output-volume mute-toggle"), { locked = true })
hl.bind(cmd .. " + F11", hl.dsp.exec_cmd("swayosd-client --output-volume lower"), { locked = true, repeating = true })
hl.bind(cmd .. " + F12", hl.dsp.exec_cmd("swayosd-client --output-volume raise"), { locked = true, repeating = true })

hl.bind(cmd .. " + " .. opt .. " + K", hl.dsp.exec_cmd(s.scripts .. "/keymap.sh toggle"), d("Switch keymap profile"))
